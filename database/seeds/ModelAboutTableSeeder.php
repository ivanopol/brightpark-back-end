    ...
    public function run()
    {
        $model_about = [
            ...
            [
                'model_id' => 3,
                'type_id' => 20,
                'image' => 'xray_exterior.jpg',
                'image_mobile' => 'xray_exterior.png',
                'title' => 'УЗНАВАЕМЫЙ ВСЮДУ',
                'description' => 'Экспрессивная пластика кузова и лаконичный силуэт. Лента светодиодов, заметная издалека… Этот автомобиль не потеряется в калейдоскопе городских улиц. Здесь он чувствует себя в своей стихии.',
                'type' => 'exterior',
            ],
            [
                'model_id' => 3,
                'type_id' => 20,
                'image' => 'xray_interior.jpg',
                'image_mobile' => 'xray_interior.png',
                'title' => 'ОБРАЗЦОВАЯ ПРАКТИЧНОСТЬ',
                'description' => 'Здесь нет ничего лишнего. Каждый сантиметр поверхности использован и имеет сразу несколько задач: повышать комфорт, создавать уникальный стиль и выполнять практическую функцию. Контрастные вставки на сиденьях, мультируль или одна из многочисленных ниш и кармашков.',
                'type' => 'interior',
            ],
            [
                'model_id' => 3,
                'type_id' => 20,
                'image' => 'xray_comfort.jpg',
                'image_mobile' => 'xray_comfort.png',
                'title' => 'СВОЙ ЛИЧНЫЙ МИКРОКОСМОС',
                'description' => 'Как узнать погоду? Температуру за бортом покажет экран на комбинации приборов. Об интенсивности осадков скажет темп работы автоматических стеклоочистителей. О том, как будет меняться погода, подскажет помощник в мультимедийной системе. На себе испытывать стихию не обязательно — в любое время года XRAY создаёт комфортную атмосферу, формируя по-настоящему индивидуальный микроклимат.',
                'type' => 'comfort',
            ],
            [
                'model_id' => 3,
                'type_id' => 20,
                'image' => 'xray_security.jpg',
                'image_mobile' => 'xray_security.png',
                'title' => 'ЧУВСТВО ЗАЩИЩЕННОСТИ',
                'description' => 'Его создает высокая подоконная линия автомобиля. Его дарит динамичный мотор, мощные тормоза и послушный руль. Но есть и невидимые факторы: прочный каркас кузова, подушки безопасности и противозаносная система, которая позволяет всегда сохранять контроль над автомобилем.',
                'type' => 'safety',
            ],
            // Xray Cross
            [
                'model_id' => 3,
                'type_id' => 4,
                'image' => 'xray_cross_exterior.jpg',
                'image_mobile' => 'xray_cross_exterior.png',
                'title' => 'СТИЛЬ: ВНЕДОРОЖНЫЙ И СПОРТИВНЫЙ',
                'description' => 'Контрастный дизайн, сочетающий прочный пластик и глянец кузова. Высокая подоконная линия, узнаваемый рельеф боковин и крупные колеса с брутальной архитектурой спиц. Уже своим видом кроссовер заявляет о лидерстве. О том, что он выше всех обстоятельств, будь то плохая дорога или ненастная погода. Всегда готов к ближним и дальним маршрутам. Всегда готов быть первым.',
                'type' => 'exterior',
            ],
            [
                'model_id' => 3,
                'type_id' => 4,
                'image' => 'xray_cross_interior.jpg',
                'image_mobile' => 'xray_cross_interior.png',
                'title' => 'ИНДИВИДУАЛЬНЫЕ НАСТРОЙКИ ПРОСТРАНСТВА',
                'description' => 'Комфортное кресло водителя с микролифтом. Переднее пассажирское сиденье с откидной вперед спинкой и выдвижным ящиком снизу. USB-разъем для подзарядки гаджетов пассажиров второго ряда. В салоне много полезных элементов, и каждый продуман так, чтобы LADA XRAY Cross был удобен и в туристической поездке, и при посещении с гипермаркета. И, конечно, чтобы каждой мелочи нашлось свое место',
                'type' => 'interior',
            ],
            [
                'model_id' => 3,
                'type_id' => 4,
                'image' => 'xray_cross_comfort.jpg',
                'image_mobile' => 'xray_cross_comfort.png',
                'title' => 'СТИХИЯ ПОД КОНТРОЛЕМ',
                'description' => 'Погулять по снегу и вернуться в тепло. Наблюдать за непогодой из окна. После горной прогулки расслабиться в мягком кресле, положив руки на теплый руль… Контраст сурового климата и автомобильного уюта особенно приятен тем, что можно самому решать, чего хочется именно сейчас – природы или цивилизации.',
                'type' => 'comfort',
            ],
            [
                'model_id' => 3,
                'type_id' => 4,
                'image' => 'xray_cross_security.jpg',
                'image_mobile' => 'xray_cross_security.png',
                'title' => 'ЧУВСТВО ЗАЩИЩЕННОСТИ',
                'description' => 'Его создает мощный облик автомобиля. Его дарит динамичный мотор, отличные тормоза и послушный руль. Но есть и невидимые факторы: это прочный каркас кузова, подушки безопасности и противозаносная система, которая позволяет всегда сохранять контроль над автомобилем.',
                'type' => 'safety',
            ],
            // Largus Universal
            [
                'model_id' => 5,
                'type_id' => 3,
                'image' => 'universal_exterior.jpg',
                'image_mobile' => 'universal_exterior.png',
                'title' => 'ГЕРОЙ ДЛЯ СЕМЕЙНЫХ СНИМКОВ',
                'description' => 'LADA Largus — гармония стиля и практичности. Тот самый случай, когда крупный вместительный автомобиль выглядит легким и стремительным. Фирменный дизайн решетки радиатора и бампера, аэродинамичная форма зеркал, комбинация черного пластика и металлического глянца — модный и фотогеничный Largus придется по вкусу всей семье. Ведь этот просторный универсал создан для того, чтобы нравиться.',
                'type' => 'exterior',
            ],
            [
                'model_id' => 5,
                'type_id' => 3,
                'image' => 'universal_interior.jpg',
                'image_mobile' => 'universal_interior.png',
                'title' => 'ЦЕНТР ПРИТЯЖЕНИЯ',
                'description' => 'Говорим «LADA Largus», подразумеваем «просторный салон». Семь полноценных мест — это уникальное преимущество. Стильная панель приборов, удобные кнопки рукоятки, контрастные приборы. Каждая деталь задает особенный, интересный ритм путешествий и делает автомобиль любимым местом для сбора друзей и близких.',
                'type' => 'interior',
            ],
            [
                'model_id' => 5,
                'type_id' => 3,
                'image' => 'universal_comfort.jpg',
                'image_mobile' => 'universal_comfort.png',
                'title' => 'ГРЕЕТ ДУШУ, РУКИ И ЛОБОВОЕ СТЕКЛО',
                'description' => 'Создать в салоне автомобиля собственный микроклимат, не зависящий от погоды за бортом. Передвигаться быстро, эффективно и экономично. Простые, но важные правила жизни мы формируем и устанавливаем сами. И в этом помогает LADA Largus — автомобиль, полностью адаптированный к российской природе и дорожным условиям.',
                'type' => 'comfort',
            ],
            [
                'model_id' => 5,
                'type_id' => 3,
                'image' => 'universal_security.jpg',
                'image_mobile' => 'universal_security.png',
                'title' => 'ДОВЕРЯЕМ АВТОМОБИЛЮ',
                'description' => 'Выбирая семейный автомобиль, мы отдаем предпочтение технике, на которую можно положиться. У LADA Largus — надежная электроника и современные системы безопасности.',
                'type' => 'safety',
            ],
            // Largus Cross
            [
            ...
            [
                ...
                'image' => 'cross_interior.jpg',
                'image_mobile' => 'cross_interior.png',
                'title' => 'ИНТЕРЬЕР, СОЗДАЮЩИЙ НАСТРОЕНИЕ',
                'description' => 'Он удивительно просторный. Семь полноценных мест и много воздуха над головой — LADA Largus щедро делится пространством. И, конечно, заряжает эмоциями: для автомобиля в версии Cross создан совершенно особенный стиль, в котором комбинируется серебристое покрытие и черный глянец, сетчатая прошивка сидений и цветные вставки из экокожи.',
                'type' => 'interior',
            ],
            [
                'model_id' => 5,
                ...
                'image' => 'cross_comfort.jpg',
                'image_mobile' => 'cross_comfort.png',
                'title' => 'НАСТРОЕН НА КОМФОРТ',
                'description' => 'Создать в салоне автомобиля собственный микроклимат, не зависящий от погоды за бортом. Передвигаться быстро и экономично, не думая о качестве асфальта. Сделать каждую поездку комфортной и эффективной. Для этих задач и создан LADA Largus Cross — автомобиль, полностью адаптированный к российской природе и дорожным условиям.',
                'type' => 'comfort',
            ],
            [
                'model_id' => 5,
                'type_id' => 4,
                'image' => 'cross_security.jpg',
                'image_mobile' => 'cross_security.png',
                'title' => 'АВТОМОБИЛЬ, В КОТОРОМ УВЕРЕН',
                'description' => 'Надежная электроника, современные системы безопасности и прочный кузов. Настоящий семейный автомобиль тот, которому доверяешь.',
                'type' => 'safety',
            ],
            // Niva Legend three doors
            [
                'model_id' => 7,
                'type_id' => 11,
                'image' => 'three_doors_exterior.jpg',
                'image_mobile' => 'three_doors_exterior.png',
                'title' => 'ДИЗАЙН – ЛАКОНИЧНЫЙ И ПОЗИТИВНЫЙ',
                'description' => 'LADA Niva Legend — автомобиль со всемирно известным дизайном, в котором продумана каждая деталь. Короткие свесы улучшают проходимость на пересечённой местности и позволяют безопасно парковаться вплотную к бордюрам. Компактный кузов — это удачное решение и для города, и для леса. А скругленные линии капота, дверей и колесных арок — классическое решение, актуальное всегда и везде.',
                'type' => 'exterior',
            ],
            [
                'model_id' => 7,
                'type_id' => 11,
                'image' => 'three_doors_interior.jpg',
                'image_mobile' => 'three_doors_interior.png',
                'title' => 'НОВЫЕ ВПЕЧАТЛЕНИЯ ОТ LADA NIVA LEGEND',
                'description' => 'Сохраняя выдающиеся внедорожные свойства и классический стиль, мы из года в год делаем популярный внедорожник более комфортным, функциональным и безопасным. Благодаря модернизации интерьера меняются и ощущения от автомобиля. Именно для этого в LADA Niva Legend появились новые сиденья, панель приборов, обивки стоек и крыши.',
                'type' => 'interior',
            ],
            [
                'model_id' => 7,
                'type_id' => 11,
                'image' => 'three_doors_comfort.jpg',
                'image_mobile' => 'three_doors_comfort.png',
                'title' => 'КОМФОРТНА В ЛЮБОМ УГОЛКЕ ЗЕМЛИ',
                'description' => 'Гармония комфорта и функциональности — это философия LADA Niva Legend. Высокая посадка, отличная обзорность, энергоемкое шасси — эти качества известны давно. Но сегодня на новый уровень вышла управляемость внедорожника: для этого полностью пересмотрена кинематика шасси. Появилась более эффективная шумоизоляция, функциональный бортовой компьютер, кондиционер и подогрев сидений. Оставаясь классикой, автомобиль учитывает тренды наших дней.',
                'type' => 'comfort',
            ],
            [
                'model_id' => 7,
                'type_id' => 11,
                'image' => 'three_doors_security.jpg',
                'image_mobile' => 'three_doors_security.png',
                'title' => 'УВЕРЕННОСТЬ НА ЛЮБЫХ ДОРОГАХ',
                'description' => 'Отличная обзорность, хорошая управляемость и мощные тормоза: LADA Niva Legend полностью адаптирована для того, чтобы безопасно и эффективно передвигаться в ритме современных мегаполисов и пригородных трасс.',
                'type' => 'safety',
            ],
            // Niva Legend five doors
            [
                'model_id' => 7,
                'type_id' => 13,
                'image' => 'five_doors_exterior.jpg',
                'image_mobile' => 'five_doors_exterior.png',
                'title' => 'ДИЗАЙН – ЛАКОНИЧНЫЙ И ПОЗИТИВНЫЙ',
                'description' => 'LADA Niva Legend — автомобиль со всемирно известным дизайном, в котором продумана каждая деталь. Короткие свесы улучшают проходимость на пересечённой местности и позволяют безопасно парковаться вплотную к бордюрам. Компактный кузов — это удачное решение и для города, и для леса. А скругленные линии капота, дверей и колесных арок — классическое решение, актуальное всегда и везде.',
                'type' => 'exterior',
            ],
            [
                'model_id' => 7,
                'type_id' => 13,
                'image' => 'five_doors_interior.jpg',
                'image_mobile' => 'five_doors_interior.png',
                'title' => 'НОВЫЕ ВПЕЧАТЛЕНИЯ ОТ LADA NIVA LEGEND',
                'description' => 'Сохраняя выдающиеся внедорожные свойства и классический стиль, мы из года в год делаем популярный внедорожник более комфортным, функциональным и безопасным. Благодаря модернизации интерьера меняются и ощущения от автомобиля. Именно для этого в LADA Niva Legend появились новые сиденья, панель приборов, обивки стоек и крыши.',
                'type' => 'interior',
            ],
            [
                'model_id' => 7,
                'type_id' => 13,
                'image' => 'five_doors_comfort.jpg',
                'image_mobile' => 'five_doors_comfort.png',
                'title' => 'КОМФОРТНА В ЛЮБОМ УГОЛКЕ ЗЕМЛИ',
                'description' => 'Гармония комфорта и функциональности — это философия LADA Niva Legend. Высокая посадка, отличная обзорность, энергоемкое шасси — эти качества известны давно. Но сегодня на новый уровень вышла управляемость внедорожника: для этого полностью пересмотрена кинематика шасси. Появилась более эффективная шумоизоляция, функциональный бортовой компьютер, кондиционер и подогрев сидений. Оставаясь классикой, автомобиль учитывает тренды наших дней.',
                'type' => 'comfort',
            ],
            [
                'model_id' => 7,
                'type_id' => 13,
                'image' => 'five_doors_security.jpg',
                'image_mobile' => 'five_doors_security.png',
                'title' => 'УВЕРЕННОСТЬ НА ЛЮБЫХ ДОРОГАХ',
                'description' => 'Отличная обзорность, хорошая управляемость и мощные тормоза: LADA Niva Legend полностью адаптирована для того, чтобы безопасно и эффективно передвигаться в ритме современных мегаполисов и пригородных трасс.',
                'type' => 'safety',
            ],
            ...
            [
                'model_id' => 6,
                'type_id' => 24,
                'image' => 'travel_exterior.jpg',
                'image_mobile' => 'travel_exterior.png',
                'title' => 'КОРОЛЕВА ДОРОГ И НАПРАВЛЕНИЙ',
                'description' => 'Легендарный автомобиль гармонично смотрится и среди лесов, и на городских улицах. Чуть сглаженная угловатость, выразительные формы кузова, яркая светотехника, пластиковый обвес кузова — решительный характер автомобиля отражен в каждой детали.',
                'type' => 'exterior',
            ],
            [
                'model_id' => 6,
                'type_id' => 24,
                'image' => 'travel_interior.jpg',
                'image_mobile' => 'travel_interior.png',
                'title' => 'ПУТЕШЕСТВИЕ С КОМФОРТОМ',
                'description' => 'Дикие степи, золотые поля, море, сливающееся с небом на линии горизонта… Бескрайние пространства так и манят LADA Niva Travel. У автомобиля с широкой душой — просторный пятиместный салон, который обеспечивает комфорт для каждого. Багажник с удобной распашной дверью готов к дальним и ближним поездкам и может быть с легкостью увеличен за счет складывания задних сидений.',
                'type' => 'interior',
            ],
            [
                'model_id' => 6,
                'type_id' => 24,
                'image' => 'travel_comfort.jpg',
                'image_mobile' => 'travel_comfort.png',
                'title' => 'ВНЕДОРОЖНИК — ЭТО УДОБНО',
                'description' => 'Даже самые брутальные и дерзкие могут оказаться мягкими и приятными... где-то глубоко внутри. За внешностью сурового внедорожника скрывается комфортный салон, в котором тщательно проработан каждый элемент. Эргономичные сиденья, сенсорный экран мультимедийной системы с встроенной навигацией, кондиционер и невидимые, но ощутимые качества, например, улучшенная шумо- и виброизоляция.',
                'type' => 'comfort',
            ],
            [
                'model_id' => 6,
                'type_id' => 24,
                'image' => 'travel_security.jpg',
                'image_mobile' => 'travel_security.png',
                'title' => 'НА СЛУЖБЕ БЕЗОПАСНОСТИ',
                'description' => 'Напряженный городской трафик или извилистая грунтовка… Здесь при каждом скоростном маневре помогает отточенный годами навык. Но если непредвиденные ситуации все же случаются, в действие вступают системы безопасности.',
                'type' => 'safety',
            ],
        ];
